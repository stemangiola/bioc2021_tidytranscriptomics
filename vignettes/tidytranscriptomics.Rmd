...
The data in the airway package is a Bioconductor *RangedSummarizedExperiment* object, a type of *SummarizedExperiment* object. For more information see [here](https://bioconductor.org/packages/release/bioc/vignettes/SummarizedExperiment/inst/doc/SummarizedExperiment.html). 
...
```{r}
airway %>%
  mutate(sample_name=stringr::str_remove(sample, "SRR1039")) %>%
...
counts_scal_PCA %>%
  ...
  geom_point() +
  ggrepel::geom_text_repel(aes(label = sample_name), show.legend = FALSE) +
  custom_theme
```
