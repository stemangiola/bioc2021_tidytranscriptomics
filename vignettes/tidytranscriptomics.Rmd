...
bibliography: "`r file.path(system.file(package='bioc2021tidytranscriptomic', 'vignettes'), 'tidytranscriptomics.bib')`"
vignette: >
...
Some of the material in Part 1 was adapted from an R for RNA sequencing workshop first run [here](http://combine-australia.github.io/2016-05-11-RNAseq/). The use of the airway dataset was inspired by the [DESeq2 vignette](http://bioconductor.org/packages/devel/bioc/vignettes/DESeq2/inst/doc/DESeq2.html).
...
After we run `scale_abundance` we should see some columns have been added at the end. The column  `counts_scaled` contains the scaled counts.
...
If you want to suggest improvements for this workshop or ask questions, you can do so as described [here](https://github.com/stemangiola/monashMay5_tidytranscriptomics/blob/master/CONTRIBUTING.md).
