...
#Error in if (common.len == 1L) { : argument is of length zero
...
#   ))
#   
# Error: Problem with `mutate()` column `mitochondrion_info`.
# ℹ `mitochondrion_info = map(...)`.
...
#   name: EH3486
#   title: Blueprint/Encode RNA-seq logcounts
